...
require 'db.php';
$id = (int)($_GET['id'] ?? 0);
$stmt = $pdo->prepare("SELECT * FROM daily_channels WHERE id = ?");
$stmt->execute([$id]);
$channel = $stmt->fetch();
...
<div class="container py-4">
  ...
  <form method="post" action="daily_update_channel.php">
    ...
    <a href="daily_channels.php" class="btn btn-secondary">取消</a>
  </form>
</div>
</body>
</html>
